            ...
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                ...
                >
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div>
                            <select name="category_add" id="category_add" class="w-full rounded-xl bg-gray-100 text-sm border-none px-4 py-2">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2" placeholder="Description your idea"></textarea>
                        </div>
