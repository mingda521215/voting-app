    ...
    <div class="flex items-end justify-center min-h-screen">
        ...
        >
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h3 class="text-center text-lg font-medium text-gray-900">{{ __('Edit Comment') }}</h3>

                <form wire:submit.prevent="updateComment" action="#" method="POST" class="space-y-4 px-4 py-6">
                    <div>
                        <textarea x-ref="editComment" wire:model.defer="body" name="idea" cols="30" rows="4" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2" placeholder="{{ __('Type your comment here') }}" required></textarea>
                        @error('body')
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        ...
                        <button
                            ...
                            <span class="ml-1">{{ __('Update') }}</span>
                        </button>
                    </div>
                </form>
            </div>
